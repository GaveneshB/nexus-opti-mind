...
export const genomeWorkloads = [
  { id: "WL-Alpha", phases: [0.2, 0.8, 1.0, 0.9, 0.6, 0.3, 0.1], type: "ML Training", avgPower: 4200, match: "WL-Gamma" },
  { id: "WL-Beta", phases: [0.1, 0.3, 0.5, 0.5, 0.4, 0.2, 0.1], type: "Data Pipeline", avgPower: 1800, match: "WL-Delta" },
  { id: "WL-Gamma", phases: [0.1, 0.2, 0.3, 0.9, 1.0, 0.7, 0.2], type: "Batch Render", avgPower: 3900, match: "WL-Alpha" },
  { id: "WL-Delta", phases: [0.1, 0.4, 0.6, 0.5, 0.3, 0.2, 0.1], type: "ETL Job", avgPower: 1650, match: "WL-Beta" },
  { id: "WL-Epsilon", phases: [0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3], type: "API Server", avgPower: 2200, match: null },
];
